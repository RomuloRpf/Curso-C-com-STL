...
int main()
{   v.push_back('a');    v.push_back('i');    v.push_back('u');    v.push_back('o');
    v.push_back('e');    v.push_back('E');    v.push_back('O');    v.push_back('A');
    v.push_back('U');    v.push_back('I');
    ...
    print();
    sort(v.begin(), v.begin()+5, custom);
    sort(v.begin()+5, v.end(), custom);
    print();
    return 0;
}
