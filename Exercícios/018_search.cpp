...
int main()
{
    ...
    cout << "binary_search(21): " << (a?("Existe"):("Nao existe")) << endl << endl;
    cout << "binary_search(20): " << (b?("Existe"):("Nao existe")) << endl << endl;
    cout << "Indice de 20: " << cont<< endl << endl;
    ...
    int consultaIdade = 20;

    vector<Aluno>::iterator it2,it3;
    it2 = (lower_bound(w.begin(),w.end(),consultaIdade, comp_idade()));
    it3 = (upper_bound(w.begin(),w.end(),consultaIdade, comp_idade()));

    int j;
    for (j=it2-w.begin();j<it3-it2+1;j++)
    {
            cout << w[j] << " ";
    }
    return 0;
